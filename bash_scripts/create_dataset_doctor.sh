...
current_path="$PWD"
initialpath="$current_path/pdf_data_doctor/"
...
create_json_file_dataset('$full_path_list_string', '$current_path/rag_dataset_doctor.json')
"
    
done

echo "Processing complete. Output saved to $current_path/rag_dataset_doctor.csv"
